...
##Execute functions below at the top directory of this API
...
# Prerquisite for TTree object
# I should have put the environmental inforamation as well...
...
# Check connection by executing GetTrackerInfo
...
def go_to_position(val1, val2, val3, use_adm=True):
...
# Execute this function to close the connection safely after you have done your measurement
...
# Functions below are made for temporary investigation. (They might be useful for specific case. )
# You can ignore everything up to the main function at the bottom.
...
# main function for repeated measurement
if __name__ == "__main__":
    ...
    set_system_setting()
    # 100-time repeated measurement
    point_measure("MasterDown", 100)
